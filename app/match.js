...
// copied from browserslist-useragent package, but modified to use a custom
// browserslist result from a dynamic source
...
const matchesUA = (uaString, opts) => {
  ...
  if (opts && opts.browserslist) {
    ...
    browsers = browserslist(normalizedQuery, {
      env: opts.env,
      path: process.cwd()
    })
  }
